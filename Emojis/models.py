...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim=32):
        super(DCGenerator, self).__init__()
        self.deconv1 = deconv(in_channels=100, out_channels=conv_dim * 4, kernel_size=4, stride=1, padding=0, batch_norm=True)
        self.deconv2 = deconv(in_channels=conv_dim*4, out_channels=conv_dim * 2, kernel_size=4, stride=2, padding=1, batch_norm=True)
        self.deconv3 = deconv(in_channels=conv_dim *2, out_channels=conv_dim, kernel_size=4, stride=2, padding=1, batch_norm=True)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self):
        ...
        self.resnet_block = ResnetBlock(128)
