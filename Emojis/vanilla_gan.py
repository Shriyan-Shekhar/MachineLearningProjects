...
#     bce_loss = torch.nn.BCELoss()
    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in train_loader:
            ...
            totD_loss += D_real_loss
            totD_fake_loss += D_fake_loss
        ...
        G_losses.append((totG_loss/len(train_loader)).item())
        D_real_losses.append((totD_loss/len(train_loader)).item())
        D_fake_losses.append((totD_fake_loss/len(train_loader)).item())
...
if __name__ == '__main__':
    ...
    axs.plot(epochs, np.array(D_real_losses) + np.array(D_fake_losses), 'r')
    axs.plot(epochs, D_real_losses) 
    axs.plot(epochs, D_fake_losses) 

    plt.xlabel("epoch")
    plt.ylabel("Loss")
    plt.legend(["Generator Loss", "Discriminator Total Loss","Discriminator Real Loss","Discriminator Fake Loss"], loc='upper right')
    plt.show()
